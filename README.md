...
* **Game Architecture:** Real-time simulation kernels, data-oriented pipeline and engine design, programmable graphics pipelines (GLSL/GDShader), and scalable declarative AI (Util AI/GOAP) for massively parallel agent populationss.
