...
Systems researcher specializing in High-Performance Computing (HPC), Compiler Engineering, Parallel/Distributed Systems, and the architecture of large-scale agent systems.
